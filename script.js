        ...
        <div class="about-content">
            <div class="about-left">
                ...
                <div class="about-buttons">
                    <a href="${about.resumePath}" download="Rishi_Chauhan_Resume.pdf" class="btn-primary">
...
const renderContact = () => {
    ...
    const getIcon = (type) => {
        if (type === 'email') {
            return `<svg class="contact-icon email-icon" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
            </svg>`;
        } else if (type === 'linkedin') {
            return `<svg class="contact-icon linkedin-icon" fill="currentColor" viewBox="0 0 24 24">
